...
function postCreate(){
    ...
    countNum = new FlxSprite(-200, -200);// countdown numbers thingys
    countNum.frames = Paths.getSparrowAtlas('Numbers');
    countNum.animation.addByPrefix('1', '1', 30, false);
    countNum.animation.addByPrefix('2', '2', 30, false);
    countNum.animation.addByPrefix('3', '3', 30, false);
    countNum.animation.addByPrefix('Go', 'Go', 30, false);
    countNum.updateHitbox();
    countNum.screenCenter();
